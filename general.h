...
void menu() {
	...
	setcolor(YELLOW);
	rectangle(210, 625, 460, 725);
	rectangle(209, 624, 461, 726);
	rectangle(208, 623, 462, 727);
	rectangle(207, 622, 463, 728);
	rectangle(206, 621, 464, 729);
	strcpy(c, "THOAT GAME");
	setcolor(WHITE);
	outtextxy(222, 665, c);
}
...
int Read_score(int score){
	FILE *fptr;
	fptr = fopen("rapid_score.txt", "r");
	char line[100];
	int x1 = 200,y1 = 100;
    while (fgets(line, sizeof(line), fptr)) {
    	outtextxy(x1, y1, line);
    	y1+= 30;
    }
    delay(5000);
  	fclose(fptr);
